...
<div class="content p-2">
    <div class="d-flex justify-content-between align-items-center p-2">
        <strong class="font-weight-bold" style="font-size:20px">ثبت بنر جدید</strong>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card p-2">
                ...
                <form action="{{route('panel.banners.store')}}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-9">
                            <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            <div class="col-12 col-lg-4 form-group">
                                <label for="image_cover">
                                    <img id="preview-image-cover-before-upload" src="{{asset('./previewImage.gif')}}" style="max-width: 200px" alt="preview image" >
                    ...
                    <button type="submit" class="btn btn-success">ثبت بنر</button>
                </form>
            </div>
        </div>
    </div>
