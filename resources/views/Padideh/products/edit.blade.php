...
<div class="content p-2">
    <div class="d-flex justify-content-between align-items-center p-2">
        <strong class="font-weight-bold" style="font-size:20px">ویرایش اطلاعات{{$product->name}}</strong>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card p-2">
                ...
                <form action="{{route('panel.products.update',$product->id)}}" enctype="multipart/form-data" method="post">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-9">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6 form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="price" value="{{old('price') ?: $product->price}}" name="price" aria-label="price" aria-describedby="basic-addon1">
                                ...
                                <div class="col-12 col-lg-6 form-group">
                                    ...
                                    <input type="link" name="link" class="form-control" value="{{old('link') ?: $product->link}}" id="email">
                                </div>
                    ...
                    <a class="btn btn-secondary" href="{{route('panel.products.index')}}">بازگشت</a>
                </form>
            </div>
        </div>
    </div>
